...
RX_FILTER_BANDS: list[RxFilterBand] = [
    ...
    RxFilterBand(FreqRange(7770, 7870), FreqRange(7460, 7560), BOTH_DIR_MASK, 0, BandFilter.BAND_FILTER_LTE13,
                 13, 1, 1, EXTRA_DATA_SWAP_FOR_AND_REV_MASK, CalDataLookup.COVERT872CALDATALOOKUP_NO_LOOKUP, 54),
    ...
    RxFilterBand(FreqRange(7030, 7330), FreqRange(7580, 7880), BOTH_DIR_MASK, 0, BandFilter.BAND_FILTER_LTE28,
                 28, 1, 2, EXTRA_DATA_SWAP_FOR_AND_REV_MASK, CalDataLookup.COVERT872CALDATALOOKUP_LTE_28A, 57),
    ...
    RxFilterBand(FreqRange(8320, 8620), FreqRange(7910, 8210), BOTH_DIR_MASK, 0, BandFilter.BAND_FILTER_LTE20,
                 20, 1, 1, EXTRA_DATA_SWAP_FOR_AND_REV_MASK, CalDataLookup.COVERT872CALDATALOOKUP_LTE_20, 64),
...
# Fast lookup dictionary (hardware_id -> RxFilterBand)
